...
<div class="row">
<div class="col-sm-8">
<h1 class="mainTitle"><font face="Garamond" size="6px" >Doctor | Manage Patients</font></h1>
</div>
<ol class="breadcrumb">
<li>
<span>Doctor</span>
...
<td colspan="4" style="font-size:20px;color:blue">
 Patient Details</td></tr>
  ...
  <tr>
    ...
    <?php  
$row=mysqli_fetch_array(mysqli_query($con,"select * from tblmedicalhistory  where PatientID='$vid'"));
...
$ret=mysqli_query($con,"select * from tbltests  where PatientID='$vid'");
...
<table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
  <tr align="center">
   <th colspan="8" >Patient Test History</th> 
  </tr>
  <tr>
    <th>#</th>
<th>Test type</th>
...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  ...
  <tr>
    <th>Body Temprature :</th>
    <td>
    <input name="temp" placeholder="Temprature" class="form-control wd-450" required="true"></td>
  </tr>
   ...
   <tr>
    <th>Next Visit Date :</th>
    <td>
    <input name="nvd" placeholder="Date" class="form-control datepicker" absent="true" data-date-format="yyyy-mm-dd"></td>
  </tr>
