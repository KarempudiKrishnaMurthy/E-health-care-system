...
body {
  ...
  background-size: cover;
	...
	<body class="login" style="text-align:center">
		<center>
		<div class="row">
			<div class="main-login col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4">
				<div class="logo margin-top-30">
				<a href="../../index.html">	<h2><b> EHCS | Doctor Login</b></h2></a>
				</div>
				...
				<div class="box-login">
					...
					<div class="copyright">
						&copy; <span class="current-year"></span><span class="text-bold text-uppercase"><b> EHCS </b></span>. <span><b>All rights reserved</b></span>
					</div>
