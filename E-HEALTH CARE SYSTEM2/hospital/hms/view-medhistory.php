...
if(isset($_POST['submit']))
  {
   ...
   $pres=$_POST['pres'];
    $nvd=$_POST['nvd'];
      ...
      $query.=mysqli_query($con, "insert   tblmedicalhistory(PatientID,BloodPressure,BloodSugar,Weight,Temperature,MedicalPres)value('$vid','$bp','$bs','$weight','$temp','$pres','$nvd')");
    if ($query) {
