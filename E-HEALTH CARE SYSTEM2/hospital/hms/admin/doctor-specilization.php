...
if(isset($_POST['search']))
{
    ...
    $query = "SELECT * FROM `Dentist` WHERE CONCAT(`Dentist_ID`, `Dentist_First_Name`, `Dentist_Last_Name`, 
    `Gender`, `DOB`, `Specialist`, `Qualification`, `Phone_No`, `Email_ID`, `Address`, `Dept_No` ) 
    LIKE '%".$valueToSearch."%'";
...
{
    $connect = mysqli_connect("localhost:3399", "root", "", "hms");
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle"><font face="Garamond" size="6px" >Admin | Add Doctor Specialization</font></h1>
																	</div>
								<ol class="breadcrumb">
									<li>
										<span>Admin</span>
