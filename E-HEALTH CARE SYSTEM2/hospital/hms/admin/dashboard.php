				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle"><font face="Garamond" size="6px" >Admin | Dashboard</font></h1>
																	</div>
								<ol class="breadcrumb">
									<li>
										<span>Admin</span>
...
<div class="col-sm-4">
									...
									<div class="panel panel-white no-radius text-center">
										<div class="panel-body">
										<span class="fa-stack fa-2x"> <i class="ti-user fa-1x text-primary"></i> <i class="fa fa-terminal fa-stack-1x fa-inverse"></i> </span>
											<h2 class="StepTitle">Add New Admin</h2>
										
											<p class="cl-effect-1">
												<a href="add-admin.php">
												<?php $result1 = mysqli_query($con,"select * FROM admin");
$num_rows1 = mysqli_num_rows($result1);
{
?>
											Current Admins:<?php echo htmlentities($num_rows1);  } ?>		
												</a>
